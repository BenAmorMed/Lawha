...
export default function ReviewForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-lg p-6 border border-gray-200">
      ...
      {error && (
        <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4" aria-live="polite">
        ...
        <div className="flex gap-2" role="radiogroup" aria-labelledby="rating-label">
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              className={`transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm ${
            ...
            >
              <Star size={32} className={star <= rating ? 'fill-star' : ''} />
            </button>
          ))}
        </div>
