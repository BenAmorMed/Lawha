  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-lg p-6 border border-gray-200">
        ...
        >
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              className="transition-colors p-1 rounded-md focus-visible:ring-2 focus-visible:ring-primary outline-none"
            >
              <Star
                size={24}
                className={star <= rating ? 'text-star fill-star' : 'text-gray-300'}
              />
            </button>
          ))}
        </div>
      ...
      <button
        ...
        className="w-full px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark disabled:bg-gray-300 font-medium transition-colors"
      >
