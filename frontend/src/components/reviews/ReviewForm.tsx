  ...
  if (!user) {
    return (
      <div className="bg-pink-50 border border-pink-100 rounded-lg p-6 text-center">
        <p className="text-primary font-medium mb-4">Sign in to leave a review</p>
        <Link href="/login">
        ...
        <div className="flex gap-1">
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              className="p-1 transition-transform hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md"
