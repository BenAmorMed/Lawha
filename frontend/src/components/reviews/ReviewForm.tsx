  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-lg p-6 border border-gray-200">
        ...
        >
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              className="p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded transition-transform hover:scale-110"
              role="radio"
      ...
      <button
        ...
        className="w-full px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark disabled:bg-gray-300 font-bold tracking-wide transition-colors"
      >
