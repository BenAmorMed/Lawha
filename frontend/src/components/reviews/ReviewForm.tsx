        ...
        <div className="flex gap-2">
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              className={`transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm p-1 ${
                star <= rating ? 'text-star scale-110' : 'text-gray-300 hover:text-gray-400'
              }`}
