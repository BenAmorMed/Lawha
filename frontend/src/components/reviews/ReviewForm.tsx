  ...
  if (!user) {
    return (
      <div className="bg-pink-50 border border-pink-100 rounded-lg p-6 text-center">
        <p className="text-gray-800 mb-4 font-medium">Sign in to leave a review</p>
        <Link href="/login">
    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-lg p-6 border border-gray-200">
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              ...
              className="transition-transform hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm p-1"
        ...
        <p className="text-sm text-gray-600 mt-2">
          {hoverRating !== null ? `${hoverRating} stars` : `${rating} out of 5 stars`}
        </p>
      </div>
