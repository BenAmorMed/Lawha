                ...
                return (
                  <div key={stars} className="flex items-center gap-2">
                    ...
                    <div
                      ...
                      aria-valuemin={0}
                      aria-valuemax={100}
                      aria-label={`${stars} stars: ${count} reviews (${percentage.toFixed(0)}%)`}
                    >
                      <div
          ...
          {reviews.map((review) => (
            <div key={review.id} className="pb-6 border-b border-gray-200 last:border-0">
              ...
              <button
                ...
                className="text-sm text-gray-600 hover:text-gray-900 border-b border-gray-300 hover:border-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded"
                aria-label={`Mark this review by ${review.userEmail || 'Anonymous'} as helpful. Current helpful count: ${review.helpfulCount}`}
              >
                <span aria-hidden="true">👍</span> Helpful ({review.helpfulCount})
              </button>
            </div>
          ))}
        </div>
