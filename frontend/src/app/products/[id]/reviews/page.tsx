    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/gallery" className="text-primary hover:text-primary-dark transition-colors font-medium">
            Back to Products
          </Link>
        </div>
      </div>
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <Link
            ...
            className="text-primary hover:text-primary-dark transition-colors font-medium mb-4 inline-block"
          >
            ← Back to Product
          </Link>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary/5 rounded-lg border border-primary/20 p-6">
              <h3 className="font-bold text-primary-dark mb-3">Review Guidelines</h3>
