        ...
        setProducts([
          {
            ...
            originalPrice: 24.99,
            imageUrl:
              'https://images.unsplash.com/photo-1514228742587-6b1558fbed20?q=80&w=800&auto=format&fit=crop',
            rating: 4.8,
            reviewsCount: 124,
            isSpecial: true,
            shippingFree: true,
          ...
          },
          {
            ...
            currentPrice: 28.0,
            imageUrl:
              'https://images.unsplash.com/photo-1574633912318-77c8e5454129?q=80&w=800&auto=format&fit=crop',
            rating: 4.6,
            reviewsCount: 57,
            isSpecial: false,
            shippingFree: true,
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className="hidden lg:block w-64 flex-shrink-0">
              <div className="sticky top-32">
                <div className="mb-10">
                  <h3 className="font-bold text-dark mb-6 tracking-wider text-sm uppercase border-b pb-2">
                    Categories
                  </h3>
      ...
      {showMobileFilters && (
        <div className="fixed inset-0 z-[100] bg-black/50 lg:hidden">
          <div className="absolute right-0 top-0 h-full w-4/5 max-w-sm bg-white p-6 shadow-xl animate-in slide-in-from-right">
            ...
            <div className="mb-8">
              <h3 className="font-bold text-dark mb-4 text-sm uppercase">
                Categories
              </h3>
              <ul className="flex flex-col gap-4">
                <li>
                  <button
                    onClick={() => handleCategoryFilter('')}
                    className={`text-sm w-full text-left py-2 px-4 rounded-md ${
                      currentCategory === ''
                ...
                {categories.map((cat) => (
                  <li key={cat}>
                    <button
                      onClick={() => handleCategoryFilter(cat)}
                      className={`text-sm w-full text-left py-2 px-4 rounded-md capitalize ${
                        currentCategory === cat
                          ? 'bg-primary text-white font-bold'
                          : 'text-gray-600 border'
                      }`}
