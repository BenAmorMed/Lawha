...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate metrics into 2 database queries instead of 6
    // Query 1: Get order counts and totals grouped by status
    ...
    return {
      summary: {
        ...
        average_order_value: totalOrders > 0 ? totalValueAll / totalOrders : 0,
