...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate 6 database queries into 2 to reduce latency.
    // Query 1: Get status breakdown and overall totals
    ...
    const recentOrders = ordersByDay.reduce(
