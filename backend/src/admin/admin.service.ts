...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate multiple aggregate queries into two grouped queries
    // Query 1: Get status breakdown, total count, revenue and average value in one go
    ...
    // Query 2: Get recent orders and daily breakdown for the last 7 days
