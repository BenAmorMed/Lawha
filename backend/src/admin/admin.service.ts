...
export class AdminService {
  ...
  async getAllOrders(filters: {
    ...
    // Optimization: Use getManyAndCount() to fetch both data and total in a single query.
  ...
  async getOrderAnalytics() {
    ...
    // Query 1: Get status breakdown, total revenue and average order value.
    // Query 2: Get daily order counts for the last 7 days.
