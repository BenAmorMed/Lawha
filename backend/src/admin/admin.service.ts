...
export class AdminService {
  ...
  async getOrderAnalytics() {
    ...
    // Query 1: Get status-based distribution and metrics (total count, sum, average)
    ...
    // Calculate summary metrics in-memory from the grouped result
    let totalOrders = 0;
    let totalRevenue = 0;
    ...
    // Query 2: Get 7-day date-based distribution
