...
export class AdminService {
  ...
  async getAllOrders(filters: {
    ...
    // Optimization: Use getManyAndCount to reduce 2 queries into 1
    // Optimization: Use loadRelationCountAndMap instead of leftJoinAndSelect for items
    // to avoid over-fetching and hydrating many entities when only count is needed.
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate 4 queries into 1 grouped query by status
    ...
    // Optimization: Consolidate 2 queries (recent orders and orders by day) into 1 grouped query
    ...
    return {
      summary: {
        ...
        average_order_value: totalOrders > 0 ? parseFloat((totalAllOrdersAmount / totalOrders).toFixed(2)) : 0,
