...
export class AdminService {
  ...
  async getAllOrders(filters: {
    ...
    // Use getManyAndCount to reduce database roundtrips
    // Use loadRelationCountAndMap to fetch items count without loading full entities (and their large designJson)
