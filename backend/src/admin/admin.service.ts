...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate 6 separate aggregate queries into 2 database roundtrips.

    // 1. Get total count, status breakdown, and revenue in ONE query
    ...
    // 2. Get recent orders count and daily breakdown in ONE query
    ...
    // Deriving summary metrics in-memory from consolidated results
    let totalOrders = 0;
    let revenue = 0;
    let totalSum = 0;
    ...
    return {
      summary: {
        ...
        revenue: revenue,
        average_order_value: totalOrders > 0 ? totalSum / totalOrders : 0,
