...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate 6 database queries into 2 grouped queries
    // Query 1: Get counts and sums grouped by status for summary metrics and breakdown
    ...
    // Query 2: Get daily counts for the last 7 days distribution
    ...
    // Deriving summary metrics in-memory
    let totalOrders = 0;
    let totalRevenue = 0;
