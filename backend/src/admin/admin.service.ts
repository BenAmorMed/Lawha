...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate multiple database queries into two.
    // Query 1: Group by status to get counts and sums for all orders.
    ...
    // Query 2: Group by day for the last 7 days.
