...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidated 6 separate database queries into 2 grouped queries
    // to reduce database roundtrips and improve performance.

    // 1. Get status-based distribution and aggregate totals in one query
    const statusAggregates = await this.ordersRepository
    ...
    // 2. Get date-based distribution for the last 7 days in one query
