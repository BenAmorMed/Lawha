...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Use exactly 2 database roundtrips by deriving summary metrics in-memory
    // Roundtrip 1: Group by status to get counts and sums for revenue/averages
    ...
    // Roundtrip 2: Group by date for last 7 days
    ...
    // Process status stats in-memory
    let totalOrders = 0;
    let revenue = 0;
    let totalValue = 0;
