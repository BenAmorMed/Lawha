...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate multiple queries into two:
    // 1. All-time stats grouped by status
    // 2. Recent stats grouped by day

    // Get stats by status (total orders, sum of totals)
