...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Reduced database roundtrips from 6 to 2 by consolidating aggregate queries.
    // Query 1: Get summary metrics and status breakdown in a single grouped query.
    ...
    // Query 2: Get 7-day statistics (total and daily breakdown) in one grouped query.
