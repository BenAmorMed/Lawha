...
export class AdminService {
  ...
  async getAllOrders(filters: {
    ...
    // Optimization: Use getManyAndCount to fetch data and total count in a single query (or as optimized by the driver)
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate 6 individual database queries into 2 grouped queries.
    // Query 1: Get status-based metrics (total, revenue, average value, breakdown)
    ...
    // Query 2: Get date-based distribution for the last 7 days
    ...
    // Calculate summary metrics in-memory to reduce database roundtrips
    let totalOrders = 0;
    let totalRevenue = 0;
    let totalPoints = 0; // Sum of all order totals for AOV calculation
    ...
    return {
      summary: {
        ...
        average_order_value: totalOrders > 0 ? totalPoints / totalOrders : 0,
