...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate metrics (Total, Revenue, Average, Status Breakdown) into ONE query grouped by status.
    // This reduces database roundtrips from 6 down to 2.
    ...
    // Recent orders (last 7 days) - Optimization: Consolidate 7-day total count and daily breakdown into a second query.
    ...
    return {
      summary: {
        ...
        average_order_value: totalOrders > 0 ? parseFloat((totalSumForAll / totalOrders).toFixed(2)) : 0,
