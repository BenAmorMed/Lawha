...
export class AdminService {
  ...
  async getAllOrders(filters: {
    ...
    // Whitelist sortBy fields to prevent SQL injection and ensure predictable performance
    ...
    // Use loadRelationCountAndMap for itemsCount to avoid fetching large designJson blobs in list view.
