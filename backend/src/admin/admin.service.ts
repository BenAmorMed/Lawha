...
export class AdminService {
  ...
  async getOrderAnalytics() {
    // Optimization: Consolidate multiple queries into two to reduce database roundtrips.
    // Query 1: Get counts and totals grouped by status to derive summary metrics.
    ...
    // Query 2: Get daily counts for the last 7 days to derive chart data and recent count.
    ...
    return {
      summary: {
        ...
        average_order_value: totalOrders > 0 ? overallSum / totalOrders : 0,
