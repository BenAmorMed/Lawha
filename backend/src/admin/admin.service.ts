...
export class AdminService {
  ...
  async getOrderAnalytics() {
    ...
    // Optimization: Consolidate 6 sequential queries into 2 parallelized operations
    // Query 1: Fetch order counts and total revenue grouped by status
    // Query 2: Fetch orders grouped by day for the last 7 days
    ...
    return {
      summary: {
        ...
        average_order_value: totalOrders > 0 ? globalTotalAmount / totalOrders : 0,
