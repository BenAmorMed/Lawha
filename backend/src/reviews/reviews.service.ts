...
export class ReviewsService {
  ...
  async createReview(
    ...
    // Denormalize stats to product entity
  ...
  async getProductReviews(
    ...
    // Fetch product to get denormalized stats
    const product = await this.productsRepository.findOne({
      where: { id: productId },
    });
  ...
  /**
   * Internal helper to denormalize product stats (avg rating and count)
   * into the Product entity for faster read performance.
   */
