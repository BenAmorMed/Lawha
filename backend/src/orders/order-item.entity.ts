...
export class OrderItem {
  ...
  /**
   * Performance: Added index on order_id to speed up order retrieval and joins.
  ...
  /**
   * Performance: Added index on product_id to optimize product-specific queries and analytics.
   */
  @Index()
